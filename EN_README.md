...
Sounder-APP-Desktop/
├── src/
│   ├── Sounder-APP.Core/            # Core library (models, services, converters)
│   │   ├── Converters/              #   Value converters
│   │   ├── Models/                  #   Data models
│   │   ├── Properties/              #   Localization resources (5 languages)
│   │   └── Services/                #   Core services
│   └── Sounder-APP.Desktop/         # Desktop application main project
│       ├── Assets/                  #   Icons, images
│       ├── Services/                #   Platform services + audio/shortcuts/singleton
│       │   ├── Windows/             #   Windows backend implementations
│       │   ├── Linux/               #   Linux backend implementations
│       │   └── Mac/                 #   macOS backend implementations
│       ├── Views/                   #   UI views
│       │   ├── Common/              #     Shared components
│       │   ├── PersonalResource/    #     Personal resource views
│       │   ├── Shop/                #     Shop views
...
│   ├── linux/                       #   Linux DEB control files + desktop entry
│   └── macos/                       #   macOS Info.plist + localized strings
├── Windows_Build.bat                # Windows build script
├── Windows_Installer.iss            # Inno Setup installer script
├── Linux_Build.sh                   # Linux build script (supports --deb / --portable)
